...
about-httpsonly-title-alert = Security Alert
about-httpsonly-title-connection-not-available = Secure Connection Not Available

# Variables:
#   $websiteUrl (String) - Url of the website that failed to load. Example: www.example.com
about-httpsonly-explanation-unavailable2 = A HTTPS version of <em>{ $websiteUrl }</em> is not available.
...
about-httpsonly-explanation-continue = If you continue, HTTPS will be turned off temporarily for this site.
